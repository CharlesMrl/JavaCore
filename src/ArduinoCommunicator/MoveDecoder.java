...
public class MoveDecoder {
    ...
    public static String decode(String arduinoCode) throws UnrecognizedMove
    {
        ...
        if ((mySplit.length == 4)&&((mySplit[0].charAt(0) == 'u')&&(mySplit[1].charAt(0) == 'd')&&(mySplit[2].charAt(0) == 'u')&&(mySplit[3].charAt(0) == 'd')))
        {
            ...
            if (((((mySplit[0].substring(1,3)).equals("a8"))&&((mySplit[1].substring(1,3)).equals("d8")))
                    ||(((mySplit[0].substring(1,3)).equals("a1"))&&((mySplit[1].substring(1,3)).equals("d1"))))
                    || ((((mySplit[2].substring(1,3)).equals("a8"))&&((mySplit[3].substring(1,3)).equals("d8")))
                    ||(((mySplit[2].substring(1,3)).equals("a1"))&&((mySplit[3].substring(1,3)).equals("d1")))))
            {
        ...
        //En passant
        else if ((mySplit.length == 3)&&((mySplit[0].charAt(0) == 'u')
                &&(mySplit[1].charAt(0) == 'd')
                &&(mySplit[2].charAt(0) == 'u')))
        {
        ...
        //Capture
                ...
                &&((mySplit[0].charAt(0) == 'u')
                &&(mySplit[1].charAt(0) == 'u')
                &&(mySplit[2].charAt(0) == 'd')))
        {
